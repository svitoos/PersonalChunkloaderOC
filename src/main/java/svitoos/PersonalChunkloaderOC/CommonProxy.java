...
public class CommonProxy {
  ...
  private final Loader.Handler chunkloaderHandler = new Loader.Handler();
  private final UpgradeChunkloaderEnv.Handler upgradeEnvHandler =
      new UpgradeChunkloaderEnv.Handler();
